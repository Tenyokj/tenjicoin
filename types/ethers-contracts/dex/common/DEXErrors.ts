...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface DEXErrorsInterface extends Interface {
  ...
  export interface DEXErrors extends BaseContract {
    
    connect(runner?: ContractRunner | null): DEXErrors;
    waitForDeployment(): Promise<this>;

    interface: DEXErrorsInterface;
